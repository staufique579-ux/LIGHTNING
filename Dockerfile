...
RUN javac -cp "JDA-5.3.0.jar:slf4j-api-2.0.13.jar:okhttp-4.12.0.jar:okio-jvm-3.6.0.jar" Main.java

CMD ["java","-cp",".:JDA-5.3.0.jar:slf4j-api-2.0.13.jar:slf4j-simple-2.0.13.jar:okhttp-4.12.0.jar:okio-jvm-3.6.0.jar","Main"]
